...
def dothething():
    ...
    for item in line:
        ...
        askjoin = "bonkersbot: please join this channel: " #modify this to define what you have to say to your bot to make it join a channel, this works over PM as well
        askleave = "bonkersbot: please leave this channel"
        asksay = ".sayin "
        cmd = "PRIVMSG " + cchannel + " :."
        masterserve = "BOOONKERS!"
        askquit = "bonkersbot: please shutdown"
...
bonkersbot = IRCBOT("bonkersbot", "bonkersbot", "fdjk190d", "irc.snoonet.org", 6697, "Bonkers of the 9th order", "#ragenorge #linuxmasterrace #lmroutside")
