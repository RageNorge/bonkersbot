...
def dothething():
    ...
    for item in line:
        ...
        bullshit = { # The bot replies to a key in this dictionary with its value. It looks for them anywhere in the message, so make sure not to use a common word to not make it spammy
                ...
                ">implying coconuts can migrate":"\x033>implying implying"
        }
        ...
        commands = { #This is the same as the bullshit dictionary except it will look in the beginning of the message for a '.', then the message right after. It only responds if 1 word is said.
                ...
                "meme":["you don't deserve memes!", "http://i.imgur.com/dZ9bEa0.png", "http://i.imgur.com/3Q46yOe.jpg", "https://i.redd.it/lvijr990ouex.jpg", "http://i.imgur.com/v5fBN1G.jpg", "http://i.imgur.com/OkDmaQ4.jpg", "http://i.imgur.com/GDNxDHt.jpg" ]
...
bonkersbot = IRCBOT("bonkersbot", "bonkersbot", "password", "irc.snoonet.org", 6697, "Bonkers of the 9th order", "#ragenorge #linuxmasterrace")
